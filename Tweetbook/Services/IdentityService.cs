...
namespace Tweetbook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        // this pieace will create or register the user and token
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            //this is for if you wanna disable this endpoint disable if you will use Roles.
        ...
        public async Task<AuthenticationResult> LoginAsync(string requestEmail, string requestPassword)
        {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            var experyDateTimeUtc = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc)
                .AddSeconds(expiryDateUnix);

            if (experyDateTimeUtc > DateTime.UtcNow)
            {
            ...
            {
                return new AuthenticationResult { Errors = new[] { "this refresh token has experid" } };
            }
